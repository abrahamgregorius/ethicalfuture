...
export default function OutcomeThree() {
    return (
        <>
            <div className="app bg-indigo-950 min-h-screen">
                ...
                >
                    <div className="h-[90vh] flex gap-12 flex-col justify-center items-center">
                        <div className="section-head">
                            <h2 className="text-5xl md:text-7xl text-center font-bold">You've chosen <span className="!text-green-400">Distrusted Optimization</span></h2>
                        </div>
                        <div className="section-body flex gap-9 justify-center items-center flex-col"
                        >
                            <p className="w-[80%] md:text-xl"
                            >Technically functional. Socially fragile.</p>
                            <p className="w-[80%] md:text-xl"
                            >The system aims for fairness or efficiency, but limited transparency or weak human oversight erodes trust.</p>
                            <p className="w-[80%] md:text-xl"
                            >Doctors feel pressured, and the public grows suspicious of algorithmic decisions.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="section section-2"
                    ...
                    <div className="section-body flex gap-9 justify-center items-center flex-col">
                        ...
                        >Technically functional. Socially fragile.</h2>
                        ...
                        <div className="grid p-4 md:p-0 max-w-[800px] grid-cols-1 gap-3 md:grid-cols-4">
                            <div className="grid-item rounded-xl p-4 border-2 flex justify-center items-center flex-col border-red-400">
                                ...
                                <p>Public trust in the healthcare system falls to 48%</p>
                            </div>
                            ...
                            <div className="grid-item rounded-xl p-4 border-2 flex justify-center items-center flex-col border-yellow-400">
                                ...
                                <p>Lawsuits related to AI medical decisions rise 210% in five years</p>
                            </div>
                            <div className="grid-item rounded-xl p-4 border-2 flex justify-center items-center flex-col border-green-400">
                                ...
                                <p>67% of health news coverage focuses on algorithm controversies</p>
                            </div>
                            <div className="grid-item rounded-xl p-4 border-2 flex justify-center items-center flex-col border-blue-400">
                                ...
                                <p>53% of doctors admit they often ignore AI recommendations quietly</p>
                            </div>
